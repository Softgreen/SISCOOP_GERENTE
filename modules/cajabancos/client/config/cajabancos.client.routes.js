    ...
    function ($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
            .state('cajabancos', {
                abstract: true,
                url: '/cajabancos',
                templateUrl: 'modules/cajabancos/client/views/_body.html',
                controller: 'CajabancosController'
            })
            .state('cajabancos.home', {
                url: '/home',
                templateUrl: 'modules/cajabancos/client/views/index.html',
                ncyBreadcrumb: {
                    label: 'Index'
                }
            })
            ...
            .state('cajabancos.app.reporte', {
                url: '/reporte',
                templateUrl: 'modules/cajabancos/client/views/form-reporteCajaBancos.html',
